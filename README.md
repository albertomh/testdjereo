...
[![python 3.14](https://img.shields.io/badge/3.14-4584b6?logo=python&logoColor=ffde57)](https://docs.python.org/3.14/whatsnew/.html)
...
You can now access the application on <http://127.0.0.1:8000> and the local SMTP server
