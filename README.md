...
[![python 3.12](https://img.shields.io/badge/3.12-4584b6?logo=python&logoColor=ffde57)](https://docs.python.org/3.10/whatsnew/3.10.html)
...
A vendorised copy of `htmx` is included in the static files directory and loaded in the
`_base.html` template.
