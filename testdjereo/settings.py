...
Generated by djereo v3.15.0-2-g13b2d9b based on Django 5.2's 'django-admin startproject'.
...
# env var needed so it can be set to `host.docker.internal` in GitHub Actions
